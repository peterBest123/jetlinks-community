...
import com.troila.datacoll.device.timeseries.DeviceTimeSeriesMetadata;
...
import com.troila.datacoll.timeseries.query.Group;
import com.troila.datacoll.timeseries.query.TimeGroup;
            ...
            .flatMap(tp2 -> {
                         ...
                         return param
                             ...
                             .execute(query -> timeSeriesManager
                                 .getService(DeviceTimeSeriesMetric.devicePropertyMetric(tp2.getT1().getId()))
                                 .queryPager(query,
                                             data -> DeviceProperty
