package com.troila.datacoll.device.configuration;

import com.troila.datacoll.device.message.DeviceMessageConnector;
import com.troila.datacoll.device.message.writer.TimeSeriesMessageWriterConnector;
